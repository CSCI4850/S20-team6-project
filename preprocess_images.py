...
#    set1File = random.randint(1,10)
#    set2File = random.randint(1,5)
#    name = str(set1File) + '.' + str(set2File)
#    if name not in done:
#        encImg = st.encode("./data/set1/{}.jpg".format(set1File), "./data/set2/{}.jpg".format(set2File), "./encodedArray_5/{}.npy".format(i))
#        decImg = st.decode("./encodedArray_5/{}.npy".format(i), "./decodedArray_5/{}.npy".format(i))
#        done.append(name)
#        i += 1
